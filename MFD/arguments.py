...
def get_args():
    ...
    parser.add_argument('--dataset', required=True, default='', choices=['utkface', 'celeba', 'cifar10s'])
    ...
    parser.add_argument('--model', default='resnet', type=str, choices=['resnet', 'shufflenet', 'mlp', 'cifar_net'])
    ...
    parser.add_argument('--repeat-time', default=10, type=int, help='the number of experimental repeats')
