...
class DataloaderFactory:
    ...
    @staticmethod
    def get_dataloader(name, img_size=224, batch_size=256, seed=0, num_workers=4, sensitive='race',
        ...
        test_dataset = DatasetFactory.get_dataset(name, test_preprocessing, 'test', sensitive=sensitive, target=target,
                                                  seed=seed, skew_ratio=skew_ratio)
        train_dataset = DatasetFactory.get_dataset(name, preprocessing, split='train', sensitive=sensitive, target=target,
