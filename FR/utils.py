...
def display_result(accuracy, ret_no_class_balance):
    ...
    print(f"ED_FR_AcrossZ: {(ret_no_class_balance['ED_FPR_AcrossZ'] + ret_no_class_balance['ED_FNR_AcrossZ']): .4f}")
...
def get_transform(dataset, method, image_size, reprogram_size=None):
    if dataset == "cifar10s":
